  ...
  <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" action="insert.mb" method="post" novalidate>
          <div class="row">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="tel" class="form-control" name="tel" placeholder="01012341234" required>
            <div class="invalid-feedback">
              전화번호를 입력해주세요.
            </div>
          </div>
          ...
          <div class="mb-3">
            <label for="area1">주소</label>
            <input type="text" class="form-control" name="area1" placeholder="서울특별시 강남구" required>
            <div class="invalid-feedback">
              주소를 입력해주세요.
            </div>
          </div>
          ...
          <div class="mb-3">
            <label for="area2">상세주소<span class="text-muted">&nbsp;(필수 아님)</span></label>
            <input type="text" class="form-control" name="area2" placeholder="상세주소를 입력해주세요.">
          </div>
