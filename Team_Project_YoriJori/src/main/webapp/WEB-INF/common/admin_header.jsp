...
<link href="<%=request.getContextPath()%>/resources/vendor/quill/quill.snow.css" rel="stylesheet">
<link href="<%=request.getContextPath()%>/resources/vendor/quill/quill.bubble.css" rel="stylesheet">
...
<link href="<%=request.getContextPath()%>/resources/css/style_am.css" rel="stylesheet">
...
<body>
			...
			<ul class="d-flex align-items-center">
				...
				<li class="nav-item dropdown pe-3">
					...
					<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
						...
						<li>
							<a class="dropdown-item d-flex align-items-center" href="<%=request.getContextPath()%>/resources/html/pages-faq.html">
	...
	<aside id="sidebar" class="sidebar">
		<ul class="sidebar-nav" id="sidebar-nav">
			<!-- 메인 화면 -->
			<li class="nav-item">
				<a class="nav-link collapsed" href="main.am">
			...
			<li class="nav-item">
				<a class="nav-link collapsed" data-bs-target="#member-nav" data-bs-toggle="collapse" href="#">
					<i class="bi bi-person-fill"></i><span>회원 관리</span> <i class="bi bi-chevron-down ms-auto"></i>
				</a>
			...
			<li class="nav-item">
				<a class="nav-link collapsed" data-bs-target="#ing-nav" data-bs-toggle="collapse" href="#">
					<i class="bi bi-egg"></i><span>식재료</span> <i class="bi bi-chevron-down ms-auto"></i>
				</a>
				<ul id="ing-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
					...
					<li>
						<a href="<%=request.getContextPath()%>/resources/html/tables-data.html">
			...
			<!-- 사용자 게시글 관리 -->
			<li class="nav-heading">사용자 레시피</li>
			<li class="nav-item">
				<a class="nav-link collapsed" data-bs-target="#user-board" data-bs-toggle="collapse" href="#">
					<i class="bi bi-cart4"></i><span>사용자 레시피</span><i class="bi bi-chevron-down ms-auto"></i>
				</a>
				<ul id="user-board" class="nav-content collapse" data-bs-parent="#sidebar-nav">
					<li>
						<a href="userBoard.am">
					...
					<li>
						<a href="#">
							<i class="bi bi-circle"></i><span>추후 옵션</span>
						</a>
					</li>
				</ul>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="<%=request.getContextPath()%>/resources/html/pages-contact.html">
