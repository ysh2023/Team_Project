				...
				<li class="nav-item dropdown"><a class="nav-link nav-icon"
					...
					<ul
						...
						<li class="message-item"><a href="#"> <img
								src="<%=request.getContextPath()%>/resources/img/messages-1.jpg"
						...
						<li class="message-item"><a href="#"> <img
								src="<%=request.getContextPath()%>/resources/img/messages-2.jpg"
								alt="" class="rounded-circle">
								<div>
									<h4>Anna Nelson</h4>
									<p>Velit asperiores et ducimus soluta repudiandae labore
						...
						<li class="message-item"><a href="#"> <img
								src="<%=request.getContextPath()%>/resources/img/messages-3.jpg"
								alt="" class="rounded-circle">
								<div>
									<h4>David Muldon</h4>
									<p>Velit asperiores et ducimus soluta repudiandae labore
