...
<div class="container"><div class="row"><div class="col-md-12">
	...
	<form action="insert.ref" method="post" id="insertForm">
	    ...
	    <div>
	    	<a  class="expand" onclick="expandAll()" style="display: show; font-size: 14pt;">
	    		<i class="icon-sort-up"></i> &nbsp; 전체 펼치기
	    	</a>
	    	<a  class="collapse" onclick="collapseAll()" style="display: none; font-size: 14pt;">
			...
			<table class="table">
				...
				<thead style="background-color: #89A621; height:30px;">
					<tr class="text-center">
						<th colspan="2">
							<a  class="expand" id="showCtg1" onclick="expandCtg(this)" style="display: show; font-size: 12pt; color: white;">
								<i class="icon-sort-up"></i>
								&nbsp; <%=category[0]%>
							</a>
							<a  class="collapse" id="hideCtg1" onclick="collapseCtg(this)" style="display: none; font-size: 12pt; color: white;">
				...
				<thead style="background-color: #89A621; height:30px;">
					<tr class="text-center">
						<th colspan="2">
							<a  class="expand" id="showCtg2" onclick="expandCtg(this)" style="font-size: 12pt; color: white;">
								<i class="icon-sort-up"></i>
								&nbsp; <%=category[1]%>
							</a>
							<a  class="collapse" id="hideCtg2" onclick="collapseCtg(this)" style="display: none; font-size: 12pt; color: white;">
								<i class="icon-sort-down"></i>
								&nbsp; <%=category[1]%>
							</a>
						</th>
				...
				<thead style="background-color: #89A621; height:30px;">
					<tr class="text-center">
						<th colspan="2">
							<a  class="expand" id="showCtg4" onclick="expandCtg(this)" style="display: show; font-size: 12pt; color: white;">
								<i class="icon-sort-up"></i>
								&nbsp; <%=category[3]%>
							</a>
							<a  class="collapse" id="hideCtg4" onclick="collapseCtg(this)" style="display: none; font-size: 12pt; color: white;">
								<i class="icon-sort-down"></i>
								&nbsp; <%=category[3]%>
							</a>
						</th>
				...
				<thead style="background-color: #89A621; height:30px;">
					<tr class="text-center">
						<th colspan="2">
							<a  class="expand" id="showCtg5" onclick="expandCtg(this)" style="display: show; font-size: 12pt; color: white;">
								<i class="icon-sort-up"></i>
								&nbsp; <%=category[4]%>
							</a>
							<a  class="collapse" id="hideCtg5" onclick="collapseCtg(this)" style="display: none; font-size: 12pt; color: white;">
								<i class="icon-sort-down"></i>
								&nbsp; <%=category[4]%>
							</a>
						</th>
				...
				<thead style="background-color: #89A621; height:30px;">
					<tr class="text-center">
						<th colspan="2">
							<a  class="expand" id="showCtg6" onclick="expandCtg(this)" style="display: show; font-size: 12pt; color: white;">
								<i class="icon-sort-up"></i>
								&nbsp; <%=category[5]%>
							</a>
							<a  class="collapse" id="hideCtg6" onclick="collapseCtg(this)" style="display: none; font-size: 12pt; color: white;">
								<i class="icon-sort-down"></i>
								&nbsp; <%=category[5]%>
							</a>
						</th>
				...
				<thead style="background-color: #89A621; height:30px;">
					<tr class="text-center">
						<th colspan="2">
							<a  class="expand" id="showCtg7" onclick="expandCtg(this)" style="display: show; font-size: 12pt; color: white;">
								<i class="icon-sort-up"></i>
								&nbsp; <%=category[6]%>
							</a>
							<a  class="collapse" id="hideCtg7" onclick="collapseCtg(this)" style="display: none; font-size: 12pt; color: white;">
								<i class="icon-sort-down"></i>
								&nbsp; <%=category[6]%>
							</a>
						</th>
