				...
				<form action="write.board" method="post" class="info" name="f" enctype="multipart/form-data">
					<div class="form-group">
						<div class="row">
							<div class="col-md-6">
								<div class="row">
									<div class="col-md-12">
										<label for="title" onclick="lodings()">* 요리명 <span class="err" id="titleMsg"></span></label><input type="text" name="title" value="${board.title }" class="form-control text-left px-3" placeholder="요리명을 입력하세요" maxlength="100">
									</div>
								</div>
								<div class="row pt-3">
									<div class="col-md-12">
										<label for="servings">몇인분 </label> <input type="number" name="servings" value="${board.servings }" class="form-control text-left px-3" placeholder="예 : 1" max="100">
									</div>
								</div>
								<div class="row pt-3">
									<div class="col-md-12">
										<label for="time">조리시간 </label> <input type="number" name="time" value="${board.time }" class="form-control text-left px-3" placeholder="조리시간(단위 : 분) 예 : 10" max="10080">
									</div>
								</div>
							</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-6">
								<label for="tags">해쉬태그 </label> <input name="tags" type="text" class="form-control text-left px-3" placeholder="태그를 작성해주세요 예 : #김 #밥" maxlength="100">
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-6">
										...
										</label> <input name="inputIngName" id="inputIngName" list="ingNameList" class="form-control " placeholder="검색 후 추가 목록에 없으면 작성 후 추가" max="20">
